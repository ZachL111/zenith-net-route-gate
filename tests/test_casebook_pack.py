"""Regression checks for the zenith-net-route-gate casebook."""
...
from casebook.harness import assert_expected, zenith_net_route_gate_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(zenith_net_route_gate_summary(), assert_expected())
